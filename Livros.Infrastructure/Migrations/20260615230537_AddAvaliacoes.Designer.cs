...
namespace Livros.Infrastructure.Migrations
{
    ...
    [Migration("20260615230537_AddAvaliacoes")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Livros.Domain.Avaliacao", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClienteId", "PedidoId", "LivroId")
                        .IsUnique();
            ...
            modelBuilder.Entity("Livros.Domain.Wishlist", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Livros.Domain.WishlistItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Livros.Domain.Wishlist", b =>
                {
                    b.HasOne("Livros.Domain.Cliente", "Cliente")
                        .WithOne("Wishlist")
                        .HasForeignKey("Livros.Domain.Wishlist", "ClienteId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("Livros.Domain.WishlistItem", b =>
                {
                    ...
                    b.HasOne("Livros.Domain.Wishlist", "Wishlist")
                        .WithMany("Itens")
